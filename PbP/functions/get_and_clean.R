...
cleanShotData <- function(shotData) {
  ...
  # ideally this data is ready to be archived and/or combined with other stuff --
  # this is the T in the ETL
  
  # start by converting to dataframe (for my ease -- would be cool to use lists for all of the data?)
